...
<script>
    new Vue({
        ...
        methods : {
            inserdata : function () {
                $.post("<?php echo site_url('InsertData/insertinfodoctor')?>",{pk:this.pk,pressure:this.pressure,detial:this.detail});
                window.location.href = "<?php echo site_url('welcome/infodocter')?>" ;
            }
        }
    });
</script>