...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 28, 2019 at 03:31 PM
...
--
-- Table structure for table `quest_ack`
--

CREATE TABLE `quest_ack` (
  `quest_ack_id` int(11) NOT NULL,
  `quest_ack_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `quest_ack`
--

INSERT INTO `quest_ack` (`quest_ack_id`, `quest_ack_name`) VALUES
(1, 'สัตว์เลี้ยงตัวแรกชื่อ'),
(2, 'ชื่อเพื่อนสนิท'),
(3, 'อาหารที่ชอบ');
...
--
-- Table structure for table `quest_register`
--

CREATE TABLE `quest_register` (
  `quest_id` int(11) NOT NULL,
  `quest_ack_id` int(11) NOT NULL,
  `quest_awser` text COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Indexes for table `quest_ack`
--
ALTER TABLE `quest_ack`
  ADD PRIMARY KEY (`quest_ack_id`);

--
-- Indexes for table `quest_register`
--
ALTER TABLE `quest_register`
...
--
-- AUTO_INCREMENT for table `quest_ack`
--
ALTER TABLE `quest_ack`
  MODIFY `quest_ack_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `quest_register`
--
ALTER TABLE `quest_register`
